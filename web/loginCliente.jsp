        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="user" id="usuario" class="form-control" onkeyup="validacion('user');" required>
                    <!--experimental-->
                    <br>
                    <br>
                    <!--fin-->
                    <label for="pass">Contraseña: </label>
                    <input type="password" name="pass" id="contra" class="form-control" onkeyup="validacion('pass');" required>
                    <br>
                    <!--experimental2-->
                    ...
                    <div class="row texto">
                        <div class="col-6">
                            <a href="loginEmpleado.jsp">Soy un Mecánico</a> <br>
                            <a href="registroUsuario.jsp">No tengo una cuenta</a>
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-3 ">
                            <input type="submit" name="btnEnviar" value="Enviar" class="btn btn-success form-control"></button>
                        </div>
                    </div>
                    </form>
