                            ...
                            <div class="row">
                                <div class="col-6">
                                 ...
                                 <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apepatfr" class="form-control" required>
                                    </div>
                                </div>
                            </div>    
                               ...
                               <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="apematfr" class="form-control" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fecnacfr" class="form-control" >
                                    </div>
                                </div>
                            </div>  
                               ...
                               <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="emailfr" class="form-control" required>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="passfr" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                                <button type="submit" name="btnRegistrarCliente" class="btn btn-primary">Registrar</button>
