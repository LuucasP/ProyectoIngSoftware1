    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="DashboardUsuario.jsp">Inicio</a>
                ...
                <li class="active">
                    ...
                    <ul class="collapse list-unstyled" id="reservas">
                        ...
                        <li>
                            <a href="RegistrarReservaClienteDB.jsp">Registrar Nueva Reserva</a>
                        </li>
                    </ul>
                </li>
     ...
     %>
                                            <div class="card-tittle">Lista de Reservas</div>
                 ...
                 <tr> 
                     <td scope="col">Numero de Reserva</td>                      
                       ...
                       <td scope="col"> Problema</td>
                        <td scope="col">Fecha de Reserva</td>
                        <td scope="col">Hora de Reserva</td>     
