...
public final class RegistrarCliente_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <center><h2>Regístrate</h2></center>\n");
      out.write("                    <br>\n");
      out.write("                    <form action=\"servletCliente\" method=\"post\">\n");
      out.write("                    <label for=\"user\">Nombre: </label>\n");
      out.write("                    <input type=\"text\" name=\"nomre\" class=\"form-control\" ");
if(c!=null){
      out.write(" value=\"");
      out.print(c.getNom());
      out.write('"');
      ...
      out.write("                    <br>\n");
      out.write("                    <!--fin-->\n");
      out.write("                    <label for=\"pass\">Apellido paterno: </label>\n");
      out.write("                    <input type=\"text\" name=\"apepatre\" class=\"form-control\" ");
if(c!=null){
      out.write("  value=\"");
      out.print(c.getApepat());
      out.write('"');
      out.write(' ');
}
      out.write(" required/>\n");
      out.write("                    <br>\n");
      out.write("                    <br>\n");
      out.write("                     <label for=\"pass\">Apellido Materno: </label>\n");
      out.write("                    <input type=\"text\" name=\"apematre\" class=\"form-control\" ");
if(c!=null){
      out.write(" value=\"");
      out.print(c.getApemat());
      out.write('"');
      out.write(' ');
}
      out.write(" required/>\n");
      out.write("                    <br>\n");
      out.write("                    <br>\n");
      out.write("                     <label for=\"pass\">Fecnac</label>\n");
      out.write("                    <input type=\"date\" name=\"fecnacre\" class=\"form-control\" ");
if(c!=null){
      out.write("  value=\"");
      out.print(c.getFecnac());
      out.write('"');
      out.write(' ');
}
      out.write("required />\n");
      out.write("                    <br>\n");
      out.write("                    <br>\n");
      out.write("                     <label for=\"pass\">Email</label>\n");
      out.write("                    <input type=\"email\" name=\"emailre\" class=\"form-control\" ");
if(c!=null){
      out.write(" value=\"");
      ...
      out.write("                    <input type=\"password\" name=\"passre\" class=\"form-control\"  ");
if(c!=null){
      out.write(" value=\"");
      out.print(c.getPass());
      out.write('"');
      ...
      out.write("                            <a href=\"loginMecanico.html\">Soy un Mecánico</a> <br>\n");
      out.write("                            <a href=\"loginCliente.html\">Ya tengo una cuenta</a>\n");
      out.write("                        </div>\n");
      ...
      out.write("\n");
      out.write("                        <div class=\"col-3 \">\n");
      out.write("                            <input type=\"submit\" name=\"btnRegistrar\" value=\"Registrar\" class=\"btn btn-success form-control\"></button>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                    </form>\n");
      out.write("\n");
